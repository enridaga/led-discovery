...
public class RandomForestPredictor {
	...
	private static final Logger L = LoggerFactory.getLogger(RandomForestPredictor.class);
	 ...
	 * @throws IOException
	 */
	public RandomForestPredictor(String modelSource, String vocabulary) throws FileNotFoundException, IOException {
	...
	public RandomForestPredictor(SparkSession spark, String modelSource, String vocabulary) throws FileNotFoundException, IOException {
